/datum/job/rd
	...
	req_admin_notify = 1
	access = list(access_rd, access_eva, access_heads, access_tox, access_maint_tunnels, access_morgue,
...
/datum/job/roboticist
	...
	department_head = list("Research Director")
	selection_color = "#ffeeff"
	access = list(access_robotics, access_tox, access_tox_storage, access_tech_storage, access_maint_tunnels, access_morgue, access_research, access_mineral_storeroom) //As a job that handles so many corpses, it makes sense for them to have morgue access.
