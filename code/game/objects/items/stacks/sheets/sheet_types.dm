...
GLOBAL_LIST_INIT(metal_recipes, list(
	new /datum/stack_recipe("Metal Platform", /obj/structure/platform, 10, time = 40,one_per_turf = TRUE, on_floor = TRUE), //Hispania Platform Recipe
	new /datum/stack_recipe("Metal Platform Corner", /obj/structure/platform/corner, 5, time = 30, one_per_turf = TRUE, on_floor = TRUE), //Hispania Platform Recipe
...
GLOBAL_LIST_INIT(plasteel_recipes, list(
	new /datum/stack_recipe("Reinforced Plasteel Platform", /obj/structure/platform/reinforced, 10, time = 40,one_per_turf = TRUE, on_floor = TRUE), //Hispania Platform Recipe
	new /datum/stack_recipe("Reinforced Plasteel Platform Corner", /obj/structure/platform/reinforced/corner, 5, time = 30,one_per_turf = TRUE, on_floor = TRUE), //Hispania Platform Recipe
