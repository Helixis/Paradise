...
GLOBAL_LIST_INIT(metal_recipes, list(
	new /datum/stack_recipe("Metal Platform", /obj/structure/platform, 10, time = 40,one_per_turf = TRUE, on_floor = TRUE),
	new /datum/stack_recipe("Metal Platform Corner", /obj/structure/platform/corner, 5, time = 30, one_per_turf = TRUE, on_floor = TRUE),
...
GLOBAL_LIST_INIT(plasteel_recipes, list(
	...
	new /datum/stack_recipe("MReinforced Plasteel Platform Corner", /obj/structure/platform/metal2/corner, 5, time = 30,one_per_turf = TRUE, on_floor = TRUE),
