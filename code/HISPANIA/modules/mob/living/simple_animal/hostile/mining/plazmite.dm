/mob/living/simple_animal/hostile/asteroid/poison/plazmite
	...
	butcher_results = list(/obj/item/stack/sheet/bone = 1, /obj/item/reagent_containers/food/snacks/plazmiteleg = 2, /obj/item/stack/sheet/cartiplaz = 1)
	var/venom_per_bite = 3
